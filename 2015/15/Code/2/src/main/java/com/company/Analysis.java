...
public class Analysis {
        ...
        for (int i = 0; i <= 100; i++) {
            ...
            for (int j = 0; j <= 100 - i; j++) {
                ...
                for (int k = 0; k <= 100 - i - j; k++) {
                    ...
                    int calories = ((i * ingredients.get(0).getCalories()) + (j * ingredients.get(1).getCalories()) + (k * ingredients.get(2).getCalories()) + (l * ingredients.get(3).getCalories()));
    ...
    public static int getBestScoringCookie(List<Cookie> cookies) {
        ...
        for (Cookie cookie : cookies) {
            ...
            if ((currentScore > currentBest) && (cookie.getCalories() == 500)) {
